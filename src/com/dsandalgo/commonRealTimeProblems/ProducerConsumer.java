package com.dsandalgo.commonRealTimeProblems;
	 ...
	 * is a classic example of a multiprocess synchronization problem. The problem describes two processes, 
	 ...
	 * A mechanism to control the insertion and extraction from this list so that 
	 * we do not insert into list if it is full or remove from it if it is empty.
	 * 
	 */
